...
public class HandleTextFile : MonoBehaviour {
   ...
   public int index;
    ...
    public void SetQuiz2()
    {
        ...
        RandomIndex = Random.Range(0, 5);   //ex) 0,5 넣으면 0~4까지만 나온다.
        ...
        //QuizFunction.GetComponent<QuizText>().QuizPanelText = GameObject.Find("QuizPanel").transform.Find("Panel").transform.Find("Text").GetComponent<TextMesh>();
